...
I downloaded the filed from Dryad and saved them into a folder called DATA in my repo.The files then loaded into R through my directory as indicated below. I titled each data by the bone it refers to and viewed the head of the data.
...
I once again read the NEXUS file, converted to phylo object, plotten tree using ggtree by adding tip labels and applyinga tree like theme.,
